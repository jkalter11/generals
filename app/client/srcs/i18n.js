...
window.i18n.en = function() {
    return {
        ...
        'create-new-game-description': 'Click on the CREATE GAME button and a new game session will be created where you can either play against an AI or play against a human opponent. Just send the game ID generated to your opponent maybe through chat apps and the like.',
